...
class Window(QWidget):
    ...
    def ui3(self):  # 光标插入文本片段
        tc = self.te.textCursor()
        # tdf = QTextDocumentFragment.fromHtml("<h1>xxx</h1>")  # 插入html字符串
        tdf = QTextDocumentFragment.fromPlainText("<h1>xxx</h1>")  # 插入普通文本
        tc.insertFragment(tdf)  # 插入文档碎片化
